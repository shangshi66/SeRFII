...
HD_PWD='C:/Users/shish/Desktop/work/SeRFI/RSA/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decrypter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decrypter.tcl -notrace
