...
HD_PWD='C:/Users/shish/Desktop/work/SeRFI/RSA/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decrypter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decrypter.tcl
